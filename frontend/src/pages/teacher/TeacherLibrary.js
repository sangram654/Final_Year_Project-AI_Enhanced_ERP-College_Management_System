...
import { 
    ...
    FiCalendar, FiMapPin, FiUser, FiGrid, FiList
} from 'react-icons/fi';
        ...
        <div className="student-page animate-fade-in">
            ...
            <div className="section-card" style={{ marginTop: 'var(--spacing-6)', background: 'var(--info-bg)', borderLeft: '4px solid var(--info-color)' }}>
                <div style={{ padding: 'var(--spacing-4)' }}>
                    <h4 style={{ margin: '0 0 var(--spacing-2)', color: 'var(--info-color)' }}>📚 Faculty Library Rules</h4>
                    <ul style={{ margin: 0, paddingLeft: 'var(--spacing-5)', color: 'var(--text-muted)', fontSize: '0.875rem' }}>
                        ...
                        <li>Books must be returned within 30 days</li>
                        <li>Late return fine: ₹5 per day</li>
                        <li>Reference books can be borrowed for 7 days only</li>
                    </ul>
                </div>
            </div>
        </div>
