...
import { FiVideo, FiCalendar, FiClock, FiExternalLink, FiCheck, FiUsers, FiPlay } from 'react-icons/fi';
    ...
    return (
        <div className="student-page animate-fade-in">
            <div className="page-header">
                <div>
                    <h1><FiVideo /> Virtual Classes</h1>
                    <p>Join your online classes and meetings</p>
                </div>
            </div>
