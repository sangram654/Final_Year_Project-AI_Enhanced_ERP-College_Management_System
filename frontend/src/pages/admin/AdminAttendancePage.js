...
const AdminAttendancePage = () => {
    ...
    useEffect(() => {
        ...
        socket.on('connect', () => {
            console.log("🔌 Admin Attendance Socket Connected");
    ...
    return (
        <div className="student-page">
            ...
            <div className="sub-navbar" style={{
                ...
                {['All', 'Admin', 'Teacher', 'Student'].map((roleOpt) => (
                    <button
                        key={roleOpt}
                    ...
                    <table className="table">
                        ...
                        <tbody>
                            {attendance.length > 0 ? (
                                ...
                                <tr>
                                    <td colSpan="3" style={{ textAlign: 'center', color: 'var(--text-muted)' }}>No student attendance records found.</td>
                                </tr>
                            )}
                        </tbody>
                    </table>
